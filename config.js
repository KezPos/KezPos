...
window.KEZPOS = {
  ...
  downloads: {
    apk: {
      label: 'Android APK',
      url: 'https://github.com/KezPos/KezPos/releases/download/v1.1.0/KezPos-v1.1.0.apk',
      size: '77 MB',
      badge: 'Android 10+',
    },
    windows: {
      label: 'Windows App',
      url: 'https://github.com/KezPos/KezPos/releases/download/v1.1.0/KezPos-v1.1.0-setup.exe',
      size: '35 MB',
      badge: 'Windows',
    },
  },
