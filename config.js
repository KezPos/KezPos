...
window.KEZPOS = {
  ...
  downloads: {
    apk: {
      label: 'Android APK',
      url: 'https://github.com/KezPos/KezPos/releases/download/v1.1.5/KezPos-v1.1.5.apk',
      size: '36 MB',
      badge: 'Android 8+',
    },
    windows: {
      label: 'Windows App',
      url: 'https://github.com/KezPos/KezPos/releases/download/v1.1.5/KezPos-v1.1.5-setup.exe',
      size: '35 MB',
      badge: 'Windows',
    },
  },
...
(function() {
  ...
  Object.assign(wa.style, {
    ...
    boxShadow:      '0 4px 16px rgba(37,211,102,0.45), 0 2px 6px rgba(0,0,0,0.2)',
    textDecoration: 'none',
    transition:     'transform .2s, box-shadow .2s',
  });
  wa.addEventListener('mouseenter', function() {
    wa.style.transform = 'scale(1.1)';
    wa.style.boxShadow = '0 6px 24px rgba(37,211,102,0.6), 0 2px 8px rgba(0,0,0,0.25)';
  });
