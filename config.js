 ...
 */
 window.KEZPOS = {
  ...
  downloads: {
    apk: {
      label: 'Android APK',
      url: 'https://github.com/KezPos/KezPos/releases/download/v1.0.6/KezPos-v1.0.6.apk',
      size: '76 MB',
      badge: 'Android',
    },
    windows: {
      label: 'Windows App',
      url: 'https://github.com/KezPos/KezPos/releases/download/v1.0.6/KezPos-v1.0.6-setup.exe',
      size: '35 MB',
      badge: 'Windows',
    },
  },
