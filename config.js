 ...
 */
 window.KEZPOS = {
  ...
  downloads: {
    apk: {
      label: 'Android APK',
      url: 'https://github.com/KezPos/KezPos/releases/download/v1.0.5/KezPos-v1.0.5.apk',
      size: '73 MB',
      badge: 'Android',
    },
    windows: {
      label: 'Windows App',
      url: 'https://github.com/KezPos/KezPos/releases/download/v1.0.5/KezPos-v1.0.5-setup.exe',
      size: '34 MB',
      badge: 'Windows',
    },
  },
